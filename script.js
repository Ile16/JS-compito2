...
/* ESERCIZIO EXTRA 1
  Scrivi un algoritmo per verificare che,
   dati due numeri interi, il valore di uno di essi 
...
if (r == 8) {
 console.log("r ha un valore di 8")
} else if (z == 8) {
  console.log("z ha un valore di 8")
} else if (r - z == 8) {
  console.log("il risultato della sottrazione è 8")
} else if (z + r == 8) {
  console.log("il risultato dell'addizione è 8")
} else  {
...
if (totCarrello > 50) {
  let blackFriday = totCarrello * 20 /100
  totCarrello -= blackFriday
  console.log(totCarrello)
} else {
  console.log(totCarrello + shipping)
} 
